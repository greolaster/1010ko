 ...
 */
package com.t2group.frontend.penilaian;
...
public class MultiSelectView {
    ...
    public void init() {
        ...
        SelectItemGroup group1 = new SelectItemGroup("Ekonomi");
        SelectItemGroup group2 = new SelectItemGroup("Hukum");
        SelectItemGroup group3 = new SelectItemGroup("Teknik");
        SelectItemGroup group4 = new SelectItemGroup("FIS");
         
        SelectItemGroup group11 = new SelectItemGroup("Managemen");
        SelectItemGroup group12 = new SelectItemGroup("Group 1.2");
         
        SelectItemGroup group21 = new SelectItemGroup("Group 2.1");
         
        SelectItem option31 = new SelectItem("Industri");
        SelectItem option32 = new SelectItem("Pangan");
        SelectItem option33 = new SelectItem("Mesin");
        SelectItem option34 = new SelectItem("Informatika");
        SelectItem option35 = new SelectItem("Planologi");
         
        SelectItem option41 = new SelectItem("Sastra Bahasa");
